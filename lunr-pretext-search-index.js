...
var ptx_lunr_docs = [
{
  ...
  "body": " Current Edition  This textbook was last updated on . The latest pdf can be found on Github while the most up to date web based version is on Github Pages .  A note on AI: Note that many sections have been written with the help of Github’s Copilot and even Google’s Gemini . Originially I had plans to properly cite each section that was written with the help of AI but I lost track given it’s seamless integration with VScode and Android smart phones as well as any browser at this point. As such it is important to note that after September of 2025 you can assume that most if not all sections were written with the help of AI.  "
},
{
...
{
  "id": "project-examples-2",
  "level": "2",
  "url": "project-examples.html#project-examples-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "The examples below are from peers that have taken the class in the past "
},
{
...
},
{
  ...
  "number": "4.3",
  "title": "Assignment",
  "body": " Assignment   Your assignment for this module is to purchase the required equipment for your class. Note that the specific equipment will be instructor dependent so be sure you discuss with the instructor of your course before buying everything. At a minimum you must purchase a CPX or CPB but the rest of the items in your kit will depend on which modules your instructor wants you to do during the semester. Also, the CPX\/CPB requires a microUSB cable and that cable must have a data line. Many USB cables are just power and ground.    Title page with name,title and date - 5%  Introduction - 5%  All figures must have appropriate annotations, figure captions, figure labels and a paragraph of supporting text - 10%  A figure of your receipt of your purchases this semester (If you already own the CPX\/CPB you may just take a photo of you holding the device). - 60%  Using the number of students in your class, compute the probability that at least one CPX\/CPB will be shipped DOA (dead on arrival) assuming a low (p=1%) failure rate. - 20%  Appendix A - Video Details - Use the webcam on your computer to film yourself introducing yourself to me and either show me your purchased CPX\/CPB or film your screen and show the receipt that shows you've purchased the CPX\/CPB. - Pass\/Fail  Appendix B - Code used to take data and code used to plot in plain text (no screenshots) - Pass\/Fail    "
},
{
  "id": "purchase-equipment-5-2-1",
  "level": "2",
  "url": "purchase-equipment-5.html#purchase-equipment-5-2-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Note that the specific equipment will be instructor dependent so be sure you discuss with the instructor of your course before buying everything. Also, the CPX\/CPB requires a microUSB cable and that cable must have a data line. Many USB cables are just power and ground. "
},
{
  ...
  "number": "5.1",
  "title": "Thonny",
  "body": " Thonny  Thonny - https:\/\/thonny.org is a great, easy, simple and lightweight IDE that I've been using for year. The figure below is a screenshot of what Thonny looks like with a sine graph plotted.    Example Sine Graph in Thonny   "
},
{
  "id": "download-python-3-3",
  "level": "2",
  "url": "download-python-3.html#download-python-3-3",
  "type": "Figure",
  "number": "5.1.1",
  "title": "",
...
},
{
  ...
  "number": "5.2",
  "title": "Spyder",
  "body": " Spyder  Spyder - https:\/\/www.spyder-ide.org\/ is a powerful IDE that is widely used in the scientific Python community. The figure below is a screenshot of what Spyder looks like with a sine graph plotted.    Example Sine Graph in Spyder   "
},
{
...
{
  "id": "download-python-6-3",
  "level": "2",
  "url": "download-python-6.html#download-python-6-3",
  "type": "Figure",
  "number": "5.4.1",
  "title": "",
...
{
  "id": "download-python-6-9",
  "level": "2",
  "url": "download-python-6.html#download-python-6-9",
  "type": "Figure",
  "number": "5.4.2",
  "title": "",
...
{
  "id": "download-python-8-5",
  "level": "2",
  "url": "download-python-8.html#download-python-8-5",
  "type": "Figure",
  "number": "5.6.1",
  "title": "",
...
{
  "id": "download-python-8-10",
  "level": "2",
  "url": "download-python-8.html#download-python-8-10",
  "type": "Figure",
  "number": "5.6.2",
  "title": "",
...
},
{
  ...
  "number": "5.7",
  "title": "Extra Help",
  "body": " Extra Help  If you need extra help with this assignment I have a youtube video on how to install Thonny as well as a youtube video on how to install Spyder . I also have a pretty comprehensive youtube video on how to plot in matplotlib  .  "
},
{
  ...
  "number": "5.8",
  "title": "Assignment",
  "body": " Assignment   Your assignment for this project is to plot the equation below from 0 to 10 seconds and include that Figure in your report. You must add a grid and label the x-axis ‘Time (sec)' and the y-axis ‘Temperature (F)'   Title page with name,title and date - 5%  Introduction - 5%  All figures must have appropriate annotations, figure captions, figure labels and a paragraph of supporting text - 10%  Include a screenshot (entire screen) of your Python IDE (Thonny or Spyder is suggested. Do no use Python IDLE) with your code pasted into the workspace - 40%  Include the plot of temperature vs time being sure to save the figure so it is in high resolution - 40%  Appendix A - Video Details - Film yourself and your entire screen running the example code and showing the result of plt.show() - Pass\/Fail  Appendix B - Code used to take data and code used to plot in plain text (no screenshots) - Pass\/Fail     "
},
{
...
{
  "id": "getting-started-setup-6",
  "level": "2",
  "url": "getting-started-setup.html#getting-started-setup-6",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Note that if you have an old bootloader you must update the bootloader  . "
},
{
...
{
  "id": "getting-started-setup-10",
  "level": "2",
  "url": "getting-started-setup.html#getting-started-setup-10",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "The CPX can store as many Python files as possible for a 2MB flash drive but it will only run ONE Python script at a time and that file must be named main.py "
},
{
...
{
  "id": "getting-started-setup-17",
  "level": "2",
  "url": "getting-started-setup.html#getting-started-setup-17",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Now this is really important. Your CPX is a USB stick that can hold as many Python files as 2MB will allow but it can only run or execute one python script at a time. Furthermore it will only run two types of files. It will run code.py if it exists and if it can't find code.py it will run main.py If the CPX can't find main.py or code.y it will just not do anything. If you have two versions of main.py or a combination of main.py or code.py it will run one of them and not the other. Make sure you only have one version of main.py or code.by but not both! Some common things to check if your CPX isn't working. "
},
{
...
{
  "id": "installing-modules-2",
  "level": "2",
  "url": "installing-modules.html#installing-modules-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "One issue you're going to run into when you run certain codes is that you won't have some of the modules on your CPB\/CPX. "
},
{
...
},
{
  "id": "daq-4-2",
  "level": "2",
  "url": "daq-4.html#daq-4-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Note: In newer versions, unplugging your CPX will result in a loss of data. If this happens try pressing CTRL+C after you click the REPL window. "
},
{
  "id": "daq-4-3",
  "level": "2",
...
},
{
  "id": "daq-6-4",
  "level": "2",
  "url": "daq-6.html#daq-6-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "NOTE: The figure below is from an old version of the code. The newest version produces the same outcome. The only difference is that the D13 LED blinks when the code is running and the first neopixel toggles 3 different colors when the system is logging data. This allows for extra user information when operating Method 3 without a computer and the serial monitor. Note that these additions require the use of neopixel.mpy module. "
},
{
  "id": "daq-6-5",
  "level": "2",
...
},
{
  "id": "voltage-3-4",
  "level": "2",
  "url": "voltage-3.html#voltage-3-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "As I said before, some potentiometers do not have enough resistance when turned all the way down. I suggest that you put a resistor in between the third leg and ground. Some experimenters have melted plastic or gotten really hot. One student even blew up a potentiometer. "
},
{
  "id": "voltage-3-5",
  "level": "2",
...
},
{
  "id": "voltage-3-12",
  "level": "2",
  "url": "voltage-3.html#voltage-3-12",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "NOTE THAT ON LINE 6 IT READS "
},
{
  "id": "voltage-3-14",
  "level": "2",
  "url": "voltage-3.html#voltage-3-14",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Notice the minus sign in front of the equal sign. That effects a lot. "
},
{
  "id": "voltage-3-15",
  "level": "2",
...
},
{
  "id": "pitot-4-2",
  "level": "2",
  "url": "pitot-4.html#pitot-4-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "There is a typo in the video though. V1 is supposed to have a sqrt()) "
},
{
  "id": "pitot-5",
  "level": "1",
...
},
{
  "id": "modules-4-4",
  "level": "2",
  "url": "modules-4.html#modules-4-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Note that if you have a CPB you need to change that line to adafruit_circuitplayground.bluefruit import cpb. Then everywhere you see cpx you replace with cpb. "
},
{
  "id": "modules-4-7",
  "level": "2",
...
},
{
  "id": "acceleration-3-9",
  "level": "2",
  "url": "acceleration-3.html#acceleration-3-9",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Note, that some of those codes have a bias filter, truncation filter and complementary filter. That code may not work for you and you may need to tune the filters for your specific data set. Make sure to understand what each filter does and think about how it applies to your data set otherwise your code may throw an error due to the differences in your data set. "
},
{
  "id": "acceleration-4",
  "level": "1",
...
},
{
  "id": "imu-3-2",
  "level": "2",
  "url": "imu-3.html#imu-3-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "solder the header pins to the sensor "
},
{
  "id": "imu-3-3",
  "level": "2",
...
},
{
  "id": "imu-3-8",
  "level": "2",
  "url": "imu-3.html#imu-3-8",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Note that it's a good exercise when attaching I2C devices to run a scan on all connected I2C devices to make sure you can see the device and that you have the correct address (See ). "
},
{
  "id": "imu-3-9",
  "level": "2",
...
{
  "id": "servo-calibration-9",
  "level": "2",
  "url": "servo-calibration.html#servo-calibration-9",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Note: Functions in python must be after all your imports but before your while loop. If you put this function inside your while loop the code will not work "
},
{
  "id": "servo-5",
  "level": "1",
...
{
  "id": "results-discussion-4-2",
  "level": "2",
  "url": "results-discussion-4.html#results-discussion-4-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "What response does implementation of the kit yield from students? \"What did you like best about how the instructor taught the course?\" "
},
{
  "id": "tab_quotes1",
  "level": "2",
